...
````bash
Add-Migration Your_Migration_Name -Context SaiDbContext
````

Using EF Core command line tool;

````bash
dotnet ef migrations add Your_Migration_Name --context SaiDbContext
````
...
````bash
Add-Migration Your_Migration_Name -Context SaiTenantDbContext -OutputDir TenantMigrations
````

Using EF Core command line tool:

````bash
dotnet ef migrations add Your_Migration_Name --context SaiTenantDbContext --output-dir TenantMigrations
````
